...
This document is my first R Markdown document. I am learning what to do by checking out the Getting Started section on the  [R Markdown website](http://rmarkdown.rstudio.com) and the [R Markdown chapter in *R for Data Science*](https://r4ds.had.co.nz/r-markdown.html).
